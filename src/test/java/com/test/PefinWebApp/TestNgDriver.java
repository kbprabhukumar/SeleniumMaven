...
public class TestNgDriver {
	 ...
	 * System.out.println("************ Test Case - TC002 ***********"); TestData
	 * obj1=new TestData(); inputData=obj1.ReadExcelData("TC002", inputData);
	 * SignupHome obj2=new SignupHome(driver,inputData); PlanHome obj3=new
	 * PlanHome(driver,inputData); YourNewHomePlan obj4=new
	 * YourNewHomePlan(driver,inputData); }
	 * 
	 * // Test Case 3: Reads the data from test data sheet for the matching test
	 * case TC002, // passed to AUI during execution
	 * 
	 * @Test public void Test3() //throws InterruptedException, IOException
	 * 
	 * { System.out.println("************ Test Case - TC003 ***********"); TestData
	 * obj1=new TestData(); inputData=obj1.ReadExcelData("TC003", inputData);
	 * SignupHome obj2=new SignupHome(driver,inputData); PlanHome obj3=new
	 * PlanHome(driver,inputData); YourNewHomePlan obj4=new
	 * YourNewHomePlan(driver,inputData); }
	 * 
	 * // Test Case 4: Reads the data from test data sheet for the matching test
	 * case TC002, //passed to AUI during execution
	 * 
	 * @Test public void Test4() //throws InterruptedException, IOException {
	 * System.out.println("************ Test Case - TC004 ***********"); TestData
	 * obj1=new TestData(); inputData=obj1.ReadExcelData("TC004", inputData);
	 * SignupHome obj2=new SignupHome(driver,inputData); PlanHome obj3=new
	 * PlanHome(driver,inputData); YourNewHomePlan obj4=new
	 * YourNewHomePlan(driver,inputData);
	 * 
	 * }
	 * 
	 * // Test Case 5: Reads the data from test data sheet for the matching test
	 * case TC002, //passed to AUI during execution
	 * 
	 * @Test public void Test5() //throws InterruptedException, IOException {
	 * System.out.println("************ Test Case - TC005 ***********"); TestData
	 * obj1=new TestData(); inputData=obj1.ReadExcelData("TC005", inputData);
	 * SignupHome obj2=new SignupHome(driver,inputData); PlanHome obj3=new
	 * PlanHome(driver,inputData); YourNewHomePlan obj4=new
	 * YourNewHomePlan(driver,inputData);
	 * 
